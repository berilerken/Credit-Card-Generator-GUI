...
public enum CardType {
    AMERICAN_EXPRESS( prefixesFromRange(new Range(34, 34), new Range(37, 37)), list(15) ," ", "11/25", "333", " ", 100, 1000),

    VISA( prefixesFromRange(new Range(4, 4)), list( 16), " ", "10/26", "467", " ", 100 ,1000),

    MASTERCARD( prefixesFromRange(new Range(51, 55)), list(16), " ", "09/24", "123", " " , 150, 500);
